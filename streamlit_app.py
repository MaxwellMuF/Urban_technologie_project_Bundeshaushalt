...
def pages_after_login():
    ...
    raw_data = st.Page("application/src/ui/streamlit_pages/page_2_raw_data.py", title="Raw data", icon=":material/home:")
    haushalt = st.Page("application/src/ui/streamlit_pages/page_3_12years.py", title="12 years Bundeshaushalt", icon=":material/home:", default=True)
